...
export default function AdminNavbar({
  ...
  return (
    <header
      ...
      style={{ borderColor: 'rgba(255,255,255,0.14)', backgroundColor: 'var(--guander-forest)' }}
    >
      <div className="flex items-center gap-3">
        ...
        <Link href="/dashboard/admin" className="flex items-center gap-2 no-underline">
          <span className="font-bold text-base md:text-lg" style={{ color: '#ffffff' }}>
            Guander
          </span>
          <span
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="hidden sm:block text-right">
          <div className="text-sm font-semibold truncate max-w-[160px]" style={{ color: '#ffffff' }}>
            {adminName}
          </div>
