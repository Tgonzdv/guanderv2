...
export function AdminBenefitsCrudClient() {
  ...
  const currentPage = benefitType === "professional" ? currentPageProf : currentPageStore;
  const setCurrentPage = benefitType === "professional" ? setCurrentPageProf : setCurrentPageStore;
      ...
      <Card elevation={0} sx={{ border: "1px solid #d6e4da" }}>
        <CardContent>
          ...
          <Box sx={{ mt: 2 }}>
            ...
            >
              <ToggleButton value="professional" sx={{ textTransform: "none" }}>
                Profesional
              </ToggleButton>
              <ToggleButton value="store" sx={{ textTransform: "none" }}>
                Tienda
              </ToggleButton>
            </ToggleButtonGroup>
          </Box>
          ...
          <Table size="small" sx={{ mt: 2 }}>
            <TableHead>
              <TableRow sx={{ backgroundColor: "#f5f5f5" }}>
                <TableCell>
                  <strong>
                    {benefitType === "professional" ? "Profesional" : "Tienda"}
                  </strong>
                </TableCell>
                <TableCell>
              ...
              {!loading && filteredItems.length === 0 && (
                <TableRow>
                  <TableCell colSpan={4} align="center">
                    {items.length === 0 ? "No hay beneficios registrados aún." : "No se encontraron resultados para tu búsqueda."}
                  </TableCell>
                </TableRow>
              )}
          ...
          {totalPages > 1 && (
            <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", px: 2, py: 2, borderTop: "1px solid #d6e4da" }}>
              <Typography variant="body2" color="textSecondary">
                Página {currentPage} de {totalPages} ({filteredItems.length} beneficios{searchTerm && " encontrados"})
              </Typography>
